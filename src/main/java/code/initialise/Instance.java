...
import code.view.ExitCommand;
import code.view.RunGuiCommand;
        ...
        public static TextMenu getInstance()
            {
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("1", ex1.toString(), ctr1));
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("2", ex2.toString(), ctr2));
                    } catch (BaseException e)
                    {
                        //System.out.println(e.getMessage());
                    }
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("3", ex3.toString(), ctr3));
                    } catch (BaseException e)
                    {
                        //System.out.println(e.getMessage());
                    }
                ...
                /*
                EXAMPLE OF AN INCORRECT PROGRAM THAT DOES NOT PASS THE TYPECHECKER!!!
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("4", ex4.toString(), ctr4));
                    } catch (BaseException e)
                    {
                        //System.out.println(e.getMessage());
                    }
                */
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("5", ex5.toString(), ctr5));
                    } catch (BaseException e)
                    {
                        //System.out.println(e.getMessage());
                    }
                ...
                IStmt ex6 = new CompStmt(new VarDeclStmt("varf", new StringType()),
                        new CompStmt(new AssignStmt("varf", new ValueExp(new StringValue("/main/java/code/test.in"))),
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("6", ex6.toString(), ctr6));
                    } catch (BaseException e)
                    {
                        //System.out.println(e.getMessage());
                    }
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("7", ex7.toString(), ctr7));
                    } catch (BaseException e)
                    {
                        //System.out.println(e.getMessage());
                    }
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("8", ex8.toString(), ctr8));
                    } catch (BaseException e)
                    {
                        //System.out.println(e.getMessage());
                    }
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("9", ex9.toString(), ctr9));
                    } catch (BaseException e)
                    {
                        //System.out.println(e.getMessage());
                    }
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("10", ex10.toString(), ctr10));
                    } catch (BaseException e)
                    {
                        //System.out.println(e.getMessage());
                    }
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("11", ex11.toString(), ctr11));
                    } catch (BaseException e)
                    {
                        //System.out.println(e.getMessage());
                    }
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("12", ex12.toString(), ctr12));
                    } catch (BaseException e)
                    {
                        //System.out.println(e.getMessage());
                    }
                ...
                try
                    {
                        ...
                        menu.addCommand(new RunGuiCommand("13", ex13.toString(), ctr13));
                    } catch (BaseException e)
                    {
                        //System.out.println(e.getMessage());
                    }
